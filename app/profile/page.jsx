                            ...
                            <button
                              onClick={async () => {
                                if (!doc.markdown || doc.markdown.trim() === "") {
                                  alert("No markdown available for this document.");
                                  return;
                                }
                                try {
                                  const res = await fetch("/api/md-to-pdf", {
                                    ...
                                    body: JSON.stringify({ markdown: doc.markdown, title: doc.projectName, subtitle: "SpecForge SRS Document", author: user?.name || "", date: new Date(doc.createdAt).toLocaleDateString() })
                                  });
                                  ...
                                  a.href = url;
                                  a.download = `${doc.projectName.replace(/\s+/g, "_")}_SpecForge.pdf`;
